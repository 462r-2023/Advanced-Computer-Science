...
public class DebuggerDemo {
    ...
    public static int[] parseNumbers(String csv) {
        ...
        for (int i = 0; i < parts.length; i++) {
            ...
            int value = Integer.parseInt(part.trim()); // Throws NumberFormatException
            result[i] = value;
        }
        return result;
    }
    ...
    public static double average(int[] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            sum += data[i] / (double) data.length; // ArrayIndexOutOfBoundsException when i ==
                                                   // data.length
        }
        return sum;
    }
    ...
    public static int fib(int n) {
        ...
        if (n <= 1) {
            return n; // Should be 0 when n == 0 and 1 when n == 1
        }
