...
public class MyPanel extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        polygons.add(new Rectangle(125, 125, 250, 250, Color.pink, Color.red));
        polygons.add(new Circle(125, 125, 250, Color.magenta, Color.green));
        polygons.add(new Rectangle(175, 175, 150, 150, Color.blue, Color.orange));
        polygons.add(new Circle(175, 175, 150, Color.blue, Color.blue));
