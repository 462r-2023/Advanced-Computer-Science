public class DogTester {
    public static void main(String[] args) {
        ...
        System.out.println("Dog1 char: " + PawesomeUtils.generateDogChar(dog1.getDogId()));
        System.out.println("Dog2 char: " + PawesomeUtils.generateDogChar(dog1.getDogId()));
        System.out.println("Dog3 char: " + PawesomeUtils.generateDogChar(dog1.getDogId()));

        System.out.println(
                "Dog1 tag: " + PawesomeUtils.generateDogTag(dog1.getDogId(), dog1.getDogChar()));
        System.out.println(
                "Dog2 tag: " + PawesomeUtils.generateDogTag(dog2.getDogId(), dog2.getDogChar()));
        System.out.println(
                "Dog3 tag: " + PawesomeUtils.generateDogTag(dog3.getDogId(), dog3.getDogChar()));
        ...
        System.out.println("Valid id for 50: " + PawesomeUtils.validateDogId(50));
        System.out.println("Valid id for 100: " + PawesomeUtils.validateDogId(100));
        System.out.println("Valid id for 250: " + PawesomeUtils.validateDogId(250));
        System.out.println("Valid id for 1000: " + PawesomeUtils.validateDogId(1000));
        System.out.println("Valid dog tag for dog1: " + PawesomeUtils.validateDogTag(dog1));
