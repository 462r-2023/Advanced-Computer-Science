...
public class Oval extends Shape {
    ...
    public void draw(Graphics g) {
        ...
        g.fillOval(xCoord[0], yCoord[0], xRadius, yRadius);// draws an oval filled with the paint
                                                           // color
        ...
        g.drawOval(xCoord[0], yCoord[0], xRadius, yRadius); // draws an oval outline with the paint
                                                            // color and stroke width
    }

    public String toString() {
        return "This shape is an Oval with a horizontal radius of " + xRadius
                + " a vertical radius of " + yRadius + " and an area of " + getArea() + ".";
    }
