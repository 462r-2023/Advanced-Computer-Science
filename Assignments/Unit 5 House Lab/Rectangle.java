...
public class Rectangle extends Shape {
    ...
    // Sets the coordinates of the rectangle, notice that it converts the x and y coordinates to
    // arrays
    ...
    public String toString() {
        return "This shape is a Rectangle with a length of " + length + " and a width of " + width
    ...
    public void draw(Graphics g) {
        ...
        g2D.fillRect(xCoord[0], yCoord[0], length, width); // draws a rectangle (filled in with
                                                           // pink)
